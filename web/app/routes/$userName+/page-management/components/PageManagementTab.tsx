      ...
      <div className="">
        ...
        <div className=" w-full py-2 flex justify-end gap-2">
          ...
          <fetcher.Form method="post" action="/$userName/page-management">
            <input type="hidden" name="pageIds" value={selectedPages.join(',')} />
            <Button type="submit" variant="destructive" name="intent" value="archive" disabled={selectedPages.length === 0}>
              Delete Selected
            </Button>
          </fetcher.Form>
        </div>
